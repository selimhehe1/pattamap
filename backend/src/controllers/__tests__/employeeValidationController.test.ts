...
} from '../employeeValidationController';
...
describe('Employee Validation Controller', () => {
  ...
  describe('voteOnEmployee', () => {
    ...
    it('should return 401 if not authenticated', async () => {
      app = express();
      app.use(express.json());
      app.post('/api/employees/:id/validation-vote', voteOnEmployee);
  ...
  describe('getValidationStats', () => {
    ...
    it('should return validation stats for employee', async () => {
      ...
      (supabase.from as jest.Mock).mockImplementation(() => {
        callCount++;
        if (callCount === 1) {
          return createMockChain({ data: mockVotes, error: null });
        }
        // User levels
        return createMockChain({
          data: [
  ...
  describe('getMyVotes', () => {
    ...
    it('should return user vote history', async () => {
      ...
      (supabase.from as jest.Mock).mockImplementation(() =>
        createMockChain({ data: mockVotes, error: null })
      );
    ...
    it('should return 401 if not authenticated', async () => {
      app = express();
      app.use(express.json());
      app.get('/api/my-validation-votes', getMyVotes);
  ...
  describe('getMyEmployeesValidation', () => {
    ...
    it('should return employees with validation stats for owner', async () => {
      ...
      (supabase.from as jest.Mock).mockImplementation((table: string) => {
        ...
        if (callCount === 1 && table === 'establishment_owners') {
          return createMockChain({ data: mockOwnerships, error: null });
        }
        if (callCount === 2 && table === 'employees') {
          return createMockChain({ data: mockEmployees, error: null });
        }
    ...
    it('should return 401 if not authenticated', async () => {
      app = express();
      app.use(express.json());
      app.get('/api/owner/my-employees-validation', getMyEmployeesValidation);
    ...
    it('should return 500 on employee fetch error', async () => {
      ...
      (supabase.from as jest.Mock).mockImplementation(() => {
        callCount++;
        if (callCount === 1) {
          return createMockChain({ data: [{ establishment_id: 'est-123' }], error: null });
        }
  ...
  describe('toggleEmployeeVisibilityAsOwner', () => {
    ...
    it('should toggle visibility to hidden successfully', async () => {
      ...
      (supabase.from as jest.Mock).mockImplementation(() => {
        ...
        if (callCount === 2) {
          return createMockChain({ data: { id: 'ownership-123' }, error: null });
        }
    ...
    it('should return 401 if not authenticated', async () => {
      app = express();
      app.use(express.json());
      app.patch('/api/owner/employees/:id/visibility', toggleEmployeeVisibilityAsOwner);
  ...
  describe('toggleEmployeeVisibilityAsAdmin', () => {
    ...
    it('should return 401 if not authenticated', async () => {
      app = express();
      app.use(express.json());
      app.patch('/api/admin/employees/:id/visibility', toggleEmployeeVisibilityAsAdmin);
