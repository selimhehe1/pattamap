 ...
 */
router.get('/pricing/:type', getPricingOptions);
 ...
 *         description: Server error
 */
router.post('/purchase', authenticateToken, csrfProtection, vipPurchaseRateLimit, purchaseVIP);
