...
import { createMockQueryBuilder, mockSuccess, mockError } from '../../config/__mocks__/supabase';
...
describe('auditLog Middleware', () => {
  ...
  describe('createAuditLog', () => {
    ...
    it('should log error on database failure but not throw', async () => {
      ...
      // Should not throw
      await createAuditLog({ action: 'test_action' });
  ...
  describe('auditLogger middleware', () => {
    it('should call next immediately', async () => {
      ...
      await middleware(mockRequest as unknown as AuthRequest, mockResponse, mockNext);
    ...
    it('should capture success status (2xx)', async () => {
      ...
      const middleware = auditLogger('view_users', 'user');
    ...
    it('should detect denied status (4xx)', async () => {
      ...
      const middleware = auditLogger('delete_user', 'user');
    ...
    it('should detect failed status (5xx)', async () => {
      ...
      const middleware = auditLogger('create_user', 'user');
    ...
    it('should capture query parameters', async () => {
      ...
      const middleware = auditLogger('list_users', 'user');
    ...
    it('should extract resource ID from various param names', async () => {
      ...
      const middleware = auditLogger('update_user', 'user');
    ...
    it('should log critical actions to console', async () => {
      ...
      const middleware = auditLogger('delete_admin', 'user', AuditLevel.CRITICAL);
    ...
    it('should include audit level in details', async () => {
      ...
      const middleware = auditLogger('view_logs', 'audit', AuditLevel.HIGH);
      ...
      expect(capturedEntry.details.level).toBe(AuditLevel.HIGH);
    });
  });
  ...
  describe('auditAdminLogin', () => {
    it('should log successful admin login', async () => {
      ...
      auditAdminLogin(mockRequest as unknown as AuthRequest, true);
    ...
    it('should log failed admin login', async () => {
      ...
      auditAdminLogin(mockRequest as unknown as AuthRequest, false);
  ...
  describe('auditUserAction', () => {
    ...
    it('should use request user info for actor', async () => {
      ...
      auditUserAction(mockRequest as unknown as AuthRequest, 'promote_user', 'user-789');
  ...
  describe('queryAuditLogs', () => {
    ...
    it('should filter by action', async () => {
      ...
      await queryAuditLogs({ action: 'admin_login' });
    ...
    it('should filter by resourceType', async () => {
      ...
      await queryAuditLogs({ resourceType: 'user' });
    ...
    it('should filter by audit level', async () => {
      ...
      await queryAuditLogs({ level: AuditLevel.CRITICAL });

      expect(mockQuery.contains).toHaveBeenCalledWith('details', { level: AuditLevel.CRITICAL });
    });
  ...
  describe('cleanupAuditLogs', () => {
    it('should delete logs older than retention period', async () => {
      ...
      expect(logger.debug).toHaveBeenCalledWith(
        expect.stringContaining('90 days cleaned up successfully')
      );
    });
  ...
  describe('Edge cases', () => {
    it('should handle missing user in request', async () => {
      ...
      const middleware = auditLogger('anonymous_action', 'resource');

      await middleware(requestWithoutUser as unknown as AuthRequest, mockResponse, mockNext);
    ...
    it('should handle missing IP address', async () => {
      ...
      auditUserAction(requestWithoutIp as unknown as AuthRequest, 'test_action', 'target-123');
    ...
    it('should handle missing User-Agent', async () => {
      ...
      auditContentAction(requestWithoutUA as unknown as AuthRequest, 'test_action', 'content', 'id-123');
    ...
    it('should fallback to connection.remoteAddress when ip is missing', async () => {
      ...
      auditUserAction(requestWithFallbackIp as unknown as AuthRequest, 'test_action', 'target-123');
