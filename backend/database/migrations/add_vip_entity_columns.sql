-- 🆕 v10.3 Phase 1B - Add VIP Columns to Entity Tables
-- Migration: Add is_vip and vip_expires_at columns to establishments and employees
-- Date: 2025-01-18
...
-- =====================================================
-- 4. TRIGGER TO UPDATE VIP STATUS ON SUBSCRIPTION CHANGES
-- =====================================================
...
-- 3. Click "Run"
-- 4. Verify columns exist: SELECT is_vip, vip_expires_at FROM establishments LIMIT 1;
-- 5. Verify indexes created: \di idx_establishments_is_vip, idx_employees_is_vip
-- 6. Verify triggers created: \dft trigger_sync_*
--
