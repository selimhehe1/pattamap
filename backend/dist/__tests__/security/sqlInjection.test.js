...
describe('SQL Injection Security Tests', () => {
    ...
    beforeEach(() => {
        ...
        authToken = jsonwebtoken_1.default.sign({ userId: 'user-123', email: 'test@example.com', role: 'user' }, process.env.JWT_SECRET, { expiresIn: '1h' });
        ...
        it('should respect RLS policies and not bypass with SQL injection', async () => {
            ...
            for (const payload of bypassPayloads) {
                ...
                if (response.status === 200 && response.body.establishments) {
                    ...
                    response.body.establishments.forEach((est) => {
