...
jest.mock('../../services/promptpayService', () => ({
    ...
    generatePromptPayQR: jest.fn(async (amount, reference) => ({
...
describe('VIP Purchase Workflow Tests', () => {
    ...
    describe('Employee VIP Purchase', () => {
        it('should purchase VIP for employee successfully (cash payment)', async () => {
            ...
            supabase_1.supabase.from.mockImplementationOnce(() => (0, supabaseMockChain_1.createMockChain)({ data: mockEmployee, error: null }));
            // 2. Mock existing active subscription check (no active subscription)
            supabase_1.supabase.from.mockImplementationOnce(() => (0, supabaseMockChain_1.createMockChain)({ data: null, error: null }));
            // 3. Mock subscription insert
            supabase_1.supabase.from.mockImplementationOnce(() => (0, supabaseMockChain_1.createMockChain)({ data: mockSubscription, error: null }));
        ...
        it('should return 403 if user is not owner of establishment', async () => {
            ...
            supabase_1.supabase.from.mockImplementationOnce(() => (0, supabaseMockChain_1.createMockChain)({ data: null, error: null }) // Query with eq('user_id', currentUser) returns null
            );
        ...
        it('should calculate correct price for 7-day duration', async () => {
            ...
            supabase_1.supabase.from
                ...
                .mockImplementationOnce(() => (0, supabaseMockChain_1.createMockChain)({ data: mockEmployee, error: null }))
                ...
                .mockImplementationOnce(() => (0, supabaseMockChain_1.createMockChain)({ data: { id: 'sub-123' }, error: null }))
    ...
    describe('Establishment VIP Purchase', () => {
        it('should purchase VIP for establishment successfully', async () => {
            ...
            supabase_1.supabase.from
                ...
                .mockImplementationOnce(() => (0, supabaseMockChain_1.createMockChain)({ data: mockOwnership, error: null }))
                // 2. Existing subscription check
                .mockImplementationOnce(() => (0, supabaseMockChain_1.createMockChain)({ data: null, error: null }))
                // 3. Subscription insert
                .mockImplementationOnce(() => (0, supabaseMockChain_1.createMockChain)({ data: mockSubscription, error: null }))
                // 4. Transaction insert
        ...
        it('should return 403 if establishment ownership not found', async () => {
            ...
            supabase_1.supabase.from.mockReturnValue((0, supabaseMockChain_1.createMockChain)({ data: null, error: null }));
            const response = await (0, supertest_1.default)(app)
                .post('/api/vip/purchase')
                .send({
                subscription_type: 'establishment',
...
//# sourceMappingURL=vipPurchase.test.js.map