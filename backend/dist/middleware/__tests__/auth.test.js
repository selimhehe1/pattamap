...
describe('Authentication Middleware', () => {
    ...
    describe('authenticateToken', () => {
        ...
        it('should authenticate valid token from cookie', async () => {
            ...
            jsonwebtoken_1.default.verify.mockReturnValue(validDecoded);
        ...
        it('should reject invalid token', async () => {
            ...
            jsonwebtoken_1.default.verify.mockImplementation(() => { throw new Error('invalid signature'); });
            await (0, auth_1.authenticateToken)(mockRequest, mockResponse, mockNext);
            expect(statusMock).toHaveBeenCalledWith(401);
            expect(jsonMock).toHaveBeenCalledWith({
                error: 'Invalid token',
        ...
        it('should reject token with missing payload fields', async () => {
            ...
            jsonwebtoken_1.default.verify.mockReturnValue(incompleteDecoded);
            await (0, auth_1.authenticateToken)(mockRequest, mockResponse, mockNext);
            expect(statusMock).toHaveBeenCalledWith(401);
            expect(jsonMock).toHaveBeenCalledWith({
    ...
    describe('requireRole', () => {
        ...
        it('should allow access for user with correct role', () => {
            const middleware = (0, auth_1.requireRole)(['user', 'admin']);
            middleware(mockRequest, mockResponse, mockNext);
            expect(mockNext).toHaveBeenCalled();
            expect(statusMock).not.toHaveBeenCalled();
        });
        it('should deny access for user with incorrect role', () => {
            const middleware = (0, auth_1.requireRole)(['admin', 'moderator']);
            middleware(mockRequest, mockResponse, mockNext);
        ...
        it('should deny access for unauthenticated user', () => {
            ...
            const middleware = (0, auth_1.requireRole)(['user']);
            middleware(mockRequest, mockResponse, mockNext);
            expect(statusMock).toHaveBeenCalledWith(401);
            expect(jsonMock).toHaveBeenCalledWith({
    ...
    describe('requireModerator', () => {
        it('should allow access for moderator', () => {
            ...
            (0, auth_1.requireModerator)(mockRequest, mockResponse, mockNext);
            expect(mockNext).toHaveBeenCalled();
        });
