...
const requestSelfRemoval = async (req, res) => {
    try {
        ...
        const { data: existingEmployee, error: fetchError } = await supabase_1.supabase
            .from('employees')
        ...
        try {
            ...
            logger_1.logger.error('Failed to send admin notifications for self-removal:', notifyError);
        }
        res.json({
