...
describe('ModerationController', () => {
    ...
    describe('getModerationQueue', () => {
        it('should return moderation queue items successfully', async () => {
            ...
            supabase_2.supabase.from
                .mockReturnValueOnce((0, supabase_1.createMockQueryBuilder)((0, supabase_1.mockSuccess)(mockQueue)))
                .mockReturnValueOnce((0, supabase_1.createMockQueryBuilder)((0, supabase_1.mockSuccess)([mockEmployee])))
            ...
            await (0, moderationController_1.getModerationQueue)(mockRequest, mockResponse);
    ...
    describe('approveItem', () => {
        it('should approve moderation item successfully', async () => {
            ...
            supabase_2.supabase.from
                .mockReturnValueOnce((0, supabase_1.createMockQueryBuilder)((0, supabase_1.mockSuccess)(mockQueueItem)))
                .mockReturnValueOnce((0, supabase_1.createMockQueryBuilder)((0, supabase_1.mockSuccess)(mockEmployee)))
                .mockReturnValueOnce((0, supabase_1.createMockQueryBuilder)((0, supabase_1.mockSuccess)({ id: 'emp-1', status: 'approved' })))
                .mockReturnValueOnce((0, supabase_1.createMockQueryBuilder)((0, supabase_1.mockSuccess)({ ...mockQueueItem, status: 'approved' })))
                .mockReturnValueOnce((0, supabase_1.createMockQueryBuilder)((0, supabase_1.mockSuccess)(mockEmployment)));
            await (0, moderationController_1.approveItem)(mockRequest, mockResponse);
            expect(jsonMock).toHaveBeenCalledWith({
    ...
    describe('rejectItem', () => {
        it('should reject moderation item successfully', async () => {
            ...
            supabase_2.supabase.from
                .mockReturnValueOnce((0, supabase_1.createMockQueryBuilder)((0, supabase_1.mockSuccess)(mockQueueItem)))
                .mockReturnValueOnce((0, supabase_1.createMockQueryBuilder)((0, supabase_1.mockSuccess)(mockEmployee)))
                .mockReturnValueOnce((0, supabase_1.createMockQueryBuilder)((0, supabase_1.mockSuccess)({ id: 'emp-1', status: 'rejected' })))
                .mockReturnValueOnce((0, supabase_1.createMockQueryBuilder)((0, supabase_1.mockSuccess)({ ...mockQueueItem, status: 'rejected' })));
            await (0, moderationController_1.rejectItem)(mockRequest, mockResponse);
            expect(jsonMock).toHaveBeenCalledWith({
    ...
    describe('getModerationStats', () => {
        it('should return moderation statistics', async () => {
            ...
            supabase_2.supabase.from
                .mockReturnValueOnce((0, supabase_1.createMockQueryBuilder)((0, supabase_1.mockSuccess)(Array(15).fill({ id: 'x' })))) // pending: 15
                .mockReturnValueOnce((0, supabase_1.createMockQueryBuilder)((0, supabase_1.mockSuccess)(Array(120).fill({ id: 'x' })))) // approved: 120
                .mockReturnValueOnce((0, supabase_1.createMockQueryBuilder)((0, supabase_1.mockSuccess)(Array(8).fill({ id: 'x' })))) // rejected: 8
                .mockReturnValueOnce((0, supabase_1.createMockQueryBuilder)((0, supabase_1.mockSuccess)(Array(5).fill({ id: 'x' })))) // employees: 5
                .mockReturnValueOnce((0, supabase_1.createMockQueryBuilder)((0, supabase_1.mockSuccess)(Array(7).fill({ id: 'x' })))) // establishments: 7
                .mockReturnValueOnce((0, supabase_1.createMockQueryBuilder)((0, supabase_1.mockSuccess)(Array(3).fill({ id: 'x' })))); // comments: 3
            await (0, moderationController_1.getModerationStats)(mockRequest, mockResponse);
            expect(jsonMock).toHaveBeenCalledWith({
                stats: {
                    total_pending: 15,
                    total_approved: 120,
    ...
    describe('getReports', () => {
        it('should return user reports successfully', async () => {
            ...
            supabase_2.supabase.from.mockReturnValueOnce((0, supabase_1.createMockQueryBuilder)((0, supabase_1.mockSuccess)(mockReports)));
            await (0, moderationController_1.getReports)(mockRequest, mockResponse);
            expect(jsonMock).toHaveBeenCalledWith({
    ...
    describe('resolveReport', () => {
        it('should resolve report with dismiss action', async () => {
            ...
            supabase_2.supabase.from
                .mockReturnValueOnce((0, supabase_1.createMockQueryBuilder)((0, supabase_1.mockSuccess)(mockReport)))
                .mockReturnValueOnce((0, supabase_1.createMockQueryBuilder)((0, supabase_1.mockSuccess)({ ...mockReport, status: 'resolved' })));
            await (0, moderationController_1.resolveReport)(mockRequest, mockResponse);
            expect(jsonMock).toHaveBeenCalledWith({
...
//# sourceMappingURL=moderationController.test.js.map