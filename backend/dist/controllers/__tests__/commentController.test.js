...
describe('CommentController', () => {
    ...
    describe('getComments', () => {
        it('should return comments for an employee', async () => {
            ...
            await (0, commentController_1.getComments)(mockRequest, mockResponse);
    ...
    describe('createComment', () => {
        it('should create a comment successfully', async () => {
            ...
            await (0, commentController_1.createComment)(mockRequest, mockResponse);
        ...
        it('should return 400 if user already rated employee', async () => {
            ...
            supabase_2.supabase.from.mockReturnValueOnce((0, supabase_1.createMockQueryBuilder)((0, supabase_1.mockSuccess)([{ id: 'existing-rating', rating: 5 }])));
            await (0, commentController_1.createComment)(mockRequest, mockResponse);
            expect(statusMock).toHaveBeenCalledWith(400);
            expect(jsonMock).toHaveBeenCalledWith({
    ...
    describe('updateComment', () => {
        it('should allow owner to update own comment', async () => {
            ...
            await (0, commentController_1.updateComment)(mockRequest, mockResponse);
            expect(jsonMock).toHaveBeenCalledWith({
    ...
    describe('deleteComment', () => {
        it('should allow owner to delete own comment', async () => {
            ...
            await (0, commentController_1.deleteComment)(mockRequest, mockResponse);
            expect(jsonMock).toHaveBeenCalledWith({
    ...
    describe('reportComment', () => {
        it('should report a comment successfully', async () => {
            ...
            await (0, commentController_1.reportComment)(mockRequest, mockResponse);
            expect(statusMock).toHaveBeenCalledWith(201);
            expect(jsonMock).toHaveBeenCalledWith({
    ...
    describe('getEmployeeRatings', () => {
        it('should return employee ratings with distribution', async () => {
            ...
            await (0, commentController_1.getEmployeeRatings)(mockRequest, mockResponse);
            expect(jsonMock).toHaveBeenCalledWith({
    ...
    describe('getUserRating', () => {
        it('should return user rating for employee', async () => {
            ...
            await (0, commentController_1.getUserRating)(mockRequest, mockResponse);
            expect(jsonMock).toHaveBeenCalledWith({
    ...
    describe('updateUserRating', () => {
        it('should create new rating if none exists', async () => {
            ...
            await (0, commentController_1.updateUserRating)(mockRequest, mockResponse);
            expect(jsonMock).toHaveBeenCalledWith({
...
//# sourceMappingURL=commentController.test.js.map