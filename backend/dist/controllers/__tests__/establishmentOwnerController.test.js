...
const establishmentOwnerController_1 = require("../establishmentOwnerController");
...
describe('establishmentOwnerController', () => {
    ...
    beforeEach(() => {
        ...
        // Setup routes
        app.get('/api/admin/establishments/:id/owners', establishmentOwnerController_1.getEstablishmentOwners);
        app.get('/api/establishments/my-owned', establishmentOwnerController_1.getMyOwnedEstablishments);
        app.post('/api/admin/establishments/:id/owners', establishmentOwnerController_1.assignEstablishmentOwner);
        app.delete('/api/admin/establishments/:id/owners/:userId', establishmentOwnerController_1.removeEstablishmentOwner);
        app.patch('/api/admin/establishments/:id/owners/:userId', establishmentOwnerController_1.updateEstablishmentOwnerPermissions);
    ...
    describe('getEstablishmentOwners', () => {
        ...
        it('should return all owners for an establishment', async () => {
            ...
            supabase_1.supabase.from.mockImplementation(() => {
                callCount++;
                if (callCount === 1) {
                    return (0, supabase_2.createMockQueryBuilder)((0, supabase_2.mockSuccess)(mockEstablishment));
                }
                return (0, supabase_2.createMockQueryBuilder)((0, supabase_2.mockSuccess)(mockOwners));
            });
        ...
        it('should return 500 on database error fetching owners', async () => {
            ...
            supabase_1.supabase.from.mockImplementation(() => {
                callCount++;
                if (callCount === 1) {
                    return (0, supabase_2.createMockQueryBuilder)((0, supabase_2.mockSuccess)({ id: establishmentId, name: 'Test Bar' }));
                }
                return (0, supabase_2.createMockQueryBuilder)((0, supabase_2.mockError)('Database error'));
            });
            const response = await (0, supertest_1.default)(app)
                .get(`/api/admin/establishments/${establishmentId}/owners`);
    ...
    describe('getMyOwnedEstablishments', () => {
        ...
        it('should return all establishments owned by the user', async () => {
            ...
            supabase_1.supabase.from.mockReturnValue((0, supabase_2.createMockQueryBuilder)((0, supabase_2.mockSuccess)(mockOwnerships)));
            const response = await (0, supertest_1.default)(app)
    ...
    describe('assignEstablishmentOwner', () => {
        ...
        it('should assign a user as owner successfully', async () => {
            ...
            supabase_1.supabase.from.mockImplementation((table) => {
                ...
                if (callCount === 2 && table === 'users') {
                    return (0, supabase_2.createMockQueryBuilder)((0, supabase_2.mockSuccess)(mockTargetUser));
                }
                if (callCount === 3 && table === 'establishment_owners') {
                    // Check existing - not found
                    return (0, supabase_2.createMockQueryBuilder)((0, supabase_2.mockNotFound)());
                }
                if (callCount === 4 && table === 'establishment_owners') {
                    // Insert new ownership
                    return (0, supabase_2.createMockQueryBuilder)((0, supabase_2.mockSuccess)(mockOwnership));
                }
        ...
        it('should return 400 if user account_type is not establishment_owner', async () => {
            ...
            supabase_1.supabase.from.mockImplementation(() => {
                ...
                if (callCount === 2) {
                    return (0, supabase_2.createMockQueryBuilder)((0, supabase_2.mockSuccess)({
                        id: targetUserId,
        ...
        it('should return 409 if user is already an owner', async () => {
            ...
            supabase_1.supabase.from.mockImplementation(() => {
                ...
                if (callCount === 3) {
                    ...
                    return (0, supabase_2.createMockQueryBuilder)((0, supabase_2.mockSuccess)({ id: 'existing-ownership' }));
                }
                return (0, supabase_2.createMockQueryBuilder)((0, supabase_2.mockSuccess)(null));
            });
            const response = await (0, supertest_1.default)(app)
        ...
        it('should auto-approve pending ownership request when assigning', async () => {
            ...
            supabase_1.supabase.from.mockImplementation((table) => {
                ...
                if (callCount === 2)
                    return (0, supabase_2.createMockQueryBuilder)((0, supabase_2.mockSuccess)(mockTargetUser));
                if (callCount === 3)
                    return (0, supabase_2.createMockQueryBuilder)((0, supabase_2.mockNotFound)()); // No existing ownership
                if (callCount === 4)
                    return (0, supabase_2.createMockQueryBuilder)((0, supabase_2.mockSuccess)(mockOwnership)); // Insert
                if (callCount === 5)
                    return (0, supabase_2.createMockQueryBuilder)((0, supabase_2.mockSuccess)(mockPendingRequest)); // Pending request found
                if (callCount === 6)
                    return (0, supabase_2.createMockQueryBuilder)((0, supabase_2.mockSuccess)(null)); // Update request
                return (0, supabase_2.createMockQueryBuilder)((0, supabase_2.mockSuccess)(null));
            });
            const response = await (0, supertest_1.default)(app)
                .post(`/api/admin/establishments/${establishmentId}/owners`)
                .send({ user_id: targetUserId });
            expect(response.status).toBe(201);
            expect(supabase_1.supabase.from).toHaveBeenCalledWith('establishment_ownership_requests');
        });
        it('should return 500 on insert error', async () => {
            ...
            supabase_1.supabase.from.mockImplementation(() => {
                ...
                if (callCount === 3) {
                    return (0, supabase_2.createMockQueryBuilder)((0, supabase_2.mockNotFound)()); // No existing
                }
                if (callCount === 4) {
                    return (0, supabase_2.createMockQueryBuilder)((0, supabase_2.mockError)('Insert failed'));
                }
                return (0, supabase_2.createMockQueryBuilder)((0, supabase_2.mockSuccess)(null));
            });
            const response = await (0, supertest_1.default)(app)
    ...
    describe('removeEstablishmentOwner', () => {
        ...
        it('should return 500 on delete error', async () => {
            ...
            supabase_1.supabase.from.mockImplementation(() => {
                ...
                return (0, supabase_2.createMockQueryBuilder)((0, supabase_2.mockError)('Delete failed'));
            });
            const response = await (0, supertest_1.default)(app)
                .delete(`/api/admin/establishments/${establishmentId}/owners/${userId}`);
            expect(response.status).toBe(500);
        ...
        it('should notify user when removed', async () => {
            ...
            await (0, supertest_1.default)(app)
                .delete(`/api/admin/establishments/${establishmentId}/owners/${userId}`);
            expect(notifyEstablishmentOwnerRemoved).toHaveBeenCalledWith(userId, 'Test Bar', establishmentId);
        });
    });
    describe('updateEstablishmentOwnerPermissions', () => {
        ...
        it('should update permissions successfully', async () => {
            ...
            supabase_1.supabase.from.mockImplementation(() => {
                callCount++;
                if (callCount === 1) {
                    return (0, supabase_2.createMockQueryBuilder)((0, supabase_2.mockSuccess)({ id: 'ownership-123' }));
                }
                return (0, supabase_2.createMockQueryBuilder)((0, supabase_2.mockSuccess)(mockUpdated));
            });
            const response = await (0, supertest_1.default)(app)
        ...
        it('should return 500 on update error', async () => {
            ...
            supabase_1.supabase.from.mockImplementation(() => {
                ...
                return (0, supabase_2.createMockQueryBuilder)((0, supabase_2.mockError)('Update failed'));
            });
            const response = await (0, supertest_1.default)(app)
                .patch(`/api/admin/establishments/${establishmentId}/owners/${userId}`)
                .send({ permissions: { can_edit: true } });
...
//# sourceMappingURL=establishmentOwnerController.test.js.map