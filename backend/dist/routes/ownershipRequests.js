...
const ownershipRequestController_1 = require("../controllers/ownershipRequestController");
 ...
 */
router.post('/', auth_1.authenticateToken, csrf_1.csrfProtection, ownershipRequestController_1.createOwnershipRequest);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/my', auth_1.authenticateToken, ownershipRequestController_1.getMyOwnershipRequests);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.delete('/:id', auth_1.authenticateToken, csrf_1.csrfProtection, ownershipRequestController_1.cancelOwnershipRequest);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/admin/all', auth_1.authenticateToken, auth_1.requireAdmin, ownershipRequestController_1.getAllOwnershipRequests);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.patch('/:id/approve', auth_1.authenticateToken, auth_1.requireAdmin, csrf_1.csrfProtection, ownershipRequestController_1.approveOwnershipRequest);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.patch('/:id/reject', auth_1.authenticateToken, auth_1.requireAdmin, csrf_1.csrfProtection, ownershipRequestController_1.rejectOwnershipRequest);
exports.default = router;
//# sourceMappingURL=ownershipRequests.js.map