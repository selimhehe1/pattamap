...
exports.mockSupabaseAuth = exports.createMockChain = void 0;
const createMockChain = (finalData = { data: [], error: null }) => {
    const chain = {
...
exports.createMockChain = createMockChain;
/**
...
const mockSupabaseAuth = (user, additionalMocks) => {
    ...
    return jest.fn((table) => {
        ...
        if (callCount === 1 && table === 'users') {
            return (0, exports.createMockChain)({ data: user, error: null });
        }
        ...
        // Default: empty array
        return (0, exports.createMockChain)({ data: [], error: null });
    });
};
exports.mockSupabaseAuth = mockSupabaseAuth;
//# sourceMappingURL=supabaseMockChain.js.map