...
import SyncIndicatorSafe from '../Common/SyncIndicatorSafe'; // 🆕 v10.4 - Offline sync queue indicator (with error boundary)
    ...
    <>
      <header
        ...
        <nav role="navigation" aria-label="Main actions" className="header-nav">
          ...
          {/* Sync Indicator - shows pending offline actions (with error boundary) */}
          <SyncIndicatorSafe compact />
